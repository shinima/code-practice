...
function closestPair(points) {
  ...
  function divideAndConquer(start, end) {
    ...
    const leftStripeIds = inStripeIds.filter(idx => idx <= mid).sort(sortIdxByY)
    const rightStripeIds = inStripeIds.filter(idx => idx > mid).sort(sortIdxByY)
